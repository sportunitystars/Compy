      ...
      { data: { ...values, isPrivate } as any },
      {
        ...
        onError: () => {
          toast({
            ...
            description: "No pudimos guardar tu hábito. Intenta de nuevo.",
            variant: "destructive"
          });
        }
      }
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <header className="bg-white sticky top-0 z-10 border-b border-border/50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-4">
          ...
          <h1 className="font-display font-bold text-xl">Crear Nuevo Hábito</h1>
        </div>
      </header>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="flex justify-end pt-4">
              ...
              >
                {createMutation.isPending ? <Loader2 className="w-5 h-5 animate-spin" /> : "Guardar Hábito"}
              </Button>
            </div>
          </form>
        </Form>
